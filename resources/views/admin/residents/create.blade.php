...
@section('page_title', 'Add Household Member')
@section('page_icon')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card" style="background: white; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); border: none;">
            ...
            <div class="card-body" style="padding: 30px;">
                ...
                <form action="{{ route('admin.residents.store', $household) }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('relation') is-invalid @enderror" id="relation" name="relation" required>
                                ...
                                <option value="Head" @if(old('relation') == 'Head') selected @endif>Head of Household</option>
                                <option value="Spouse" @if(old('relation') == 'Spouse') selected @endif>Spouse</option>
                                <option value="Child" @if(old('relation') == 'Child') selected @endif>Child</option>
                                <option value="Parent" @if(old('relation') == 'Parent') selected @endif>Parent</option>
                                <option value="Sibling" @if(old('relation') == 'Sibling') selected @endif>Sibling</option>
                                <option value="Grandchild" @if(old('relation') == 'Grandchild') selected @endif>Grandchild</option>
                                <option value="Others" @if(old('relation') == 'Others') selected @endif>Others</option>
                            </select>
                            @error('relation')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('education_level') is-invalid @enderror" id="education_level" name="education_level">
                                ...
                                <option value="Elementary" @if(old('education_level') == 'Elementary') selected @endif>Elementary</option>
                                <option value="High School" @if(old('education_level') == 'High School') selected @endif>High School</option>
                                <option value="College" @if(old('education_level') == 'College') selected @endif>College</option>
                                <option value="Post Graduate" @if(old('education_level') == 'Post Graduate') selected @endif>Post Graduate</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('occupation') is-invalid @enderror"
                                   id="occupation" name="occupation" value="{{ old('occupation') }}" placeholder="e.g., Farmer">
                            @error('occupation')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_pregnant" name="is_pregnant" value="1"
                                       @if(old('is_pregnant')) checked @endif>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('special_needs') is-invalid @enderror"
                                  ...
                                  placeholder="Any special needs or medical conditions...">{{ old('special_needs') }}</textarea>
                        @error('special_needs')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
